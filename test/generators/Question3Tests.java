...
public class Question3Tests {
    ...
    public void testGetters() {
      ...
      Assert.assertEquals(1, p1.getLeft().intValue());
      Assert.assertEquals(2, p1.getRight().intValue());

      final IOException ioException = new IOException();
      final Number aNumber = 3.2;
      final Pair<IOException, Number> p2 = new Pair<>(ioException, aNumber);
      Assert.assertSame(ioException, p2.getLeft());
      Assert.assertSame(aNumber, p2.getRight());
    }
