...
public class Question4Tests {
    ...
    public void testPairGenerator1() {
      ...
      Assert.assertEquals("A", p1.getLeft());
      Assert.assertEquals(0, p1.getRight().intValue());
    }
    ...
    public void testPairGenerator2() {
      ...
      Assert.assertEquals("B", p2.getLeft());
      Assert.assertEquals(1, p2.getRight().intValue());

      Assert.assertTrue(generator.hasNext());
      final Pair<String, Integer> p3 = generator.next();
      Assert.assertEquals("C", p3.getLeft());
      Assert.assertEquals(0, p3.getRight().intValue());
